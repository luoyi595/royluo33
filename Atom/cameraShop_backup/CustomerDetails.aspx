<%@ Page Title="Camera : Customer Details" Language="C#" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>
        <span class="CatalogTitle">Edit Your Details</span></h1>
    <h1>
    &nbsp;<asp:Label ID="UserIdLabel" runat="server" Text="test"></asp:Label>
  </h1>
