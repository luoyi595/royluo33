<%@ Page Title="Camera: Shopping Cart" Language="C#" MasterPageFile="~/BalloonShop.master"
  ...
  <p align="right">
    ...
    <div style="margin-right:auto;">
        ...
        <p style="text-align: right">
            <span>Discount State: </span>
            <asp:Label ID="discountMsgLable" runat="server" Text="Label"></asp:Label>
    </p>
        <p style="text-align: right">
            <span>-</span>
            <asp:Label ID="discountLable" runat="server" Text="Label"></asp:Label>
    </p>

    </div>
  <p style="text-align: right">
      <span>Final price: </span>
      <asp:Label ID="finalPriceLable" runat="server" Text="Label"></asp:Label>
    </p>
  <p align="right">
    ...
    <p>
        ...
        Your Email:<asp:TextBox ID="TextBoxEmailAddress" runat="server" Width="222px"></asp:TextBox>
